    ...
    <nav className="" style={{backgroundColor:"#AEBE98"}}>
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          <div>
            <NavLink to="/dashboard" className="text-white text-xl font-bold">Home</NavLink>
          </div>
          ...
          <div className={`sm:flex flex-col sm:flex-row ${isOpen ? 'block' : 'hidden'}`}>
            ...
            <NavLink to="/charts" activeClassName="text-blue-300" className="text-white hover:text-blue-700 py-2 px-4 block sm:mx-2">Graphical Visulization</NavLink>
            <NavLink to="/" activeClassName="text-blue-300" className="text-white hover:text-blue-700 py-2 px-4 block sm:mx-2">Logout</NavLink>
          </div>
        </div>
      </div>
    </nav>
